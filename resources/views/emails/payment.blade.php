                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                <tr>
                                    <td valign="top" class="bodyContent" mc:edit="body_content">
                                        ...
                                        You monthly contribution of  <strong>KES {{$request->amount}}</strong> <br>
                                        Has been successfully posted to the system on <strong>{{date('d-m-Y')}}</strong><br>
                                        Your Balance for the month is<strong>KES {{(3000-$request->amount)}}</strong><br>
                                        Please Pay your Balance to Avoid paying fine:<br>
